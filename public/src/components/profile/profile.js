    ...
    render() {
      this.shadowRoot.innerHTML = `
          ...
          <div class= "card"> 
            ...
            <img class="ImagenesOtras" src="./img/back.jpg">
            <img class="ImagenesOtras"src="./img/cancel.jpg">
            <img class="ImagenesOtras" src="./img/estrella.jpg">
            <img class="ImagenesOtras"src="./img/corazon.jpg">
            <img class="ImagenesOtras" src="./img/rayo.jpg">
